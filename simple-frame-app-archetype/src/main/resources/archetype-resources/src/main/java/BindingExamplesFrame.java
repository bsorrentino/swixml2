...
import ${package}.list.CustomListCellRenderer;
import ${package}.table.SimpleBean;
import ${package}.tree.TestTreeModel;

/**
 * The ApplicationTest shows in the usage of client attributes in swixml tags.
 *
 * @author <a href="mailto:wolf@paulus.com">Wolf Paulus</a>
 * @version ${symbol_dollar}Revision: 1.1 ${symbol_dollar}
 *
 * @since swixml 0.98
 */
...
public class BindingExamplesFrame extends JFrame  {
  ...
  public void comboAction( ActionEvent e ) {
	  ...
	  if( item!=null ) {
		  System.out.printf( "comboAction source[%s]${symbol_escape}n", item);
	  }
  }
  ...
  public void listAction( ActionEvent e ) {
	  ...
	  if( item!=null ) {
		  System.out.printf( "listAction source:[%s]${symbol_escape}n", item );
	  }
  }
  
  @Action(enabledProperty="connected")
  public void test() {
    System.out.printf( "hello world! %s${symbol_escape}n", testValue);
  ...
  public void selectNode( ActionEvent e ) {
    ...
    System.out.printf( "selectNode path=%s${symbol_escape}n", ev.getPath().toString());
  ...
  public void selectRow( ActionEvent e ) {
    ...
    System.out.printf( "selectRow firstIndex=%d lastIndex=%d valueIsAdjusting=%b${symbol_escape}n", ev.getFirstIndex(), ev.getLastIndex(), ev.getValueIsAdjusting());
  ...
  public void show( ActionEvent e ) {
      ...
      setMessage( String.format( "X:%s${symbol_escape}nY:%s", btn.getClientProperty( "X" ), btn.getClientProperty( "Y" ) ) );
  }
    ...
    public void setTestValue(String testValue) {
        ...
        System.out.printf( "updated %s${symbol_escape}n", testValue);
    }
